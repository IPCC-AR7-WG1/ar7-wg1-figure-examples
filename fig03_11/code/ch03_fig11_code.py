...
DATA = pd.read_csv('../data/final_data/map_midHolocene_models.csv',header=205)
...
data_reconstruction = pd.read_csv('../data/final_data/map_midHolocene_reconstructions.csv',header=21)
